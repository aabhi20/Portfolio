...
export default function Hero() {
  return (
    <section
      id="home"
      className="font-[Rubik] relative min-h-screen bg-[#0a0a1f] flex flex-col lg:flex-row items-center justify-center px-6 md:px-12 lg:px-20 pb-24 pt-24 lg:pt-0 lg:gap-[10vw] overflow-hidden"
    >
      {/* Left Side Text */}
