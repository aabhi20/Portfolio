...
const Skills = () => {
  return (
    <section
      id="skills"
      className="scroll-mt-24 snap-start min-h-screen bg-[#0d0a1c] text-[#c3cad9] px-6 py-16 flex items-center justify-center"
    >
      <motion.div
        ...
        viewport={{ once: true }}
        className="w-full max-w-7xl p-8 md:p-16 rounded-2xl border border-[#1f2a45] bg-[#10152b]/70 backdrop-blur-lg shadow-xl"
      >
          ...
          {skills.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex flex-col items-center text-center bg-[#0e1325]/80 backdrop-blur-md border border-[#1f2a45] rounded-2xl p-8 hover:shadow-[0_0_15px_#5d88f7]/50 hover:-translate-y-1 transition duration-300"
              >
                {/* Icon with animated ring */}
                <div className="relative mb-4">
                  <div className="bg-gradient-to-tr from-[#5d88f7] to-[#00c4ff] p-1 rounded-full animate-pulse ring-2 ring-[#202a44]">
                    <div className="bg-[#10152b] p-4 rounded-full">
                      <Icon className="text-4xl md:text-5xl text-[#5d88f7]" />
                    </div>
                  </div>
                </div>
